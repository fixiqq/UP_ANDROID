...
public class Adapter_LW extends ArrayAdapter<Class_Quote> {

    private List<Class_Quote> myObjects;

    public Adapter_LW(Context context, List<Class_Quote> myObjects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Class_Quote myObject = myObjects.get(position);
